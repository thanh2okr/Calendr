...
internal enum Strings {
  ...
  internal enum Settings {
    ...
    internal enum Events {
      ...
      /// Max title lines
      internal static let maxTitleLines = Strings.tr("Localizable", "settings.events.max_title_lines", fallback: "Max title lines")
      ...
      /// Show video call events only
      internal static let showVideoCallOnly = Strings.tr("Localizable", "settings.events.show_video_call_only", fallback: "Show video call events only")
    }
