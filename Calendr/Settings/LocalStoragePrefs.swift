...
enum Prefs {
    ...
    static let highlightedWeekdaysColor = "highlighted_weekdays_color"
    ...
    static let showVideoCallOnly = "show_video_call_only"
    static let eventTitleLines = "event_title_lines"
...
func registerDefaultPrefs(in localStorage: LocalStorageProvider, calendar: Calendar = .current) {
    ...
    localStorage.register(defaults: [
        ...
        Prefs.highlightedWeekdaysColor: "FF3B3033",
        Prefs.weekCount: 6,
        ...
        Prefs.showVideoCallOnly: false,
        Prefs.eventTitleLines: 2,
...
extension LocalStorageProvider {
    ...
    @objc dynamic var highlightedWeekdaysColor: String {
        get { string(forKey: Prefs.highlightedWeekdaysColor) ?? "FF3B3033" }
        set { set(newValue, forKey: Prefs.highlightedWeekdaysColor) }
    }
    ...
    @objc dynamic var showVideoCallOnly: Bool {
        get { bool(forKey: Prefs.showVideoCallOnly) }
        set { set(newValue, forKey: Prefs.showVideoCallOnly) }
    }

    @objc dynamic var eventTitleLines: Int {
        get { integer(forKey: Prefs.eventTitleLines) }
        set { set(newValue, forKey: Prefs.eventTitleLines) }
    }
