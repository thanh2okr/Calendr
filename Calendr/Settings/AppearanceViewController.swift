...
class AppearanceViewController: NSViewController, SettingsUI {
    ...
    // Calendar — min 0.8 adds 2 smaller levels (0.80, 0.85, 0.90, 0.95) below the previous minimum
    private let calendarScalingSlider = Slider.make(minValue: 0.8, maxValue: 1.6, numberOfTickMarks: 17)
    private let calendarTextScalingSlider = Slider.make(minValue: 0.8, maxValue: 1.6, numberOfTickMarks: 17)
