...
protocol CalendarSettings {
    ...
    var highlightedWeekdaysColor: Observable<NSColor> { get }
...
protocol EventSettings: AppearanceSettings {
    ...
    var eventTitleLines: Observable<Int> { get }
}
...
protocol EventListSettings: EventSettings {
    ...
    var showVideoCallOnly: Observable<Bool> { get }
}
...
class SettingsViewModel:
    ...
    let highlightedWeekdaysColorObserver: AnyObserver<NSColor>
    ...
    let eventTitleLinesObserver: AnyObserver<Int>
    ...
    let highlightedWeekdaysColor: Observable<NSColor>
    ...
    init(
        ...
        highlightedWeekdaysColorObserver = localStorage.rx.observer(for: \.highlightedWeekdaysColor).mapObserver(\.hexString)
        ...
        toggleShowVideoCallOnly = localStorage.rx.observer(for: \.showVideoCallOnly)
        eventTitleLinesObserver = localStorage.rx.observer(for: \.eventTitleLines)
        ...
        highlightedWeekdaysColor = localStorage.rx.observe(\.highlightedWeekdaysColor).map(NSColor.init(hex:))
        ...
        showVideoCallOnly = localStorage.rx.observe(\.showVideoCallOnly)
        eventTitleLines = localStorage.rx.observe(\.eventTitleLines)
